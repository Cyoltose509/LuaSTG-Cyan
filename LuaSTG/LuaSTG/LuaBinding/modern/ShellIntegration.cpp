...
namespace luastg::binding {
    ...
    struct ShellIntegrationBinding : ShellIntegration {
        ...
        static int openFile(lua_State *const vm) {
            ...
            auto const warning = ctx.get_value<bool>(2, true);
            auto const result = core::ShellIntegration::openFile(path, warning);
        ...
        static int openDirectory(lua_State *const vm) {
            ...
            auto const path = ctx.get_value<std::string_view>(1);
            auto const warning = ctx.get_value<bool>(2, true);
            auto const result = core::ShellIntegration::openDirectory(path, warning);
            ctx.push_value(result);
            return 1;
        }
        ...
        static int openUrl(lua_State *const vm) {
            ...
            auto const warning = ctx.get_value<bool>(2, true);
            auto const result = core::ShellIntegration::openUrl(url, warning);
            ctx.push_value(result);
            return 1;
        }
    };
